...
function setupWindControls() {
    ...
    windControls.forEach(controlId => {
        ...
        control.addEventListener('input', () => {
            app.resetFlowGL();  // Reset completo della serie flowGL
            app.updatePlot();
        });
...
const app = {
    ...
    init() {
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            handleResize(); // Chiamata iniziale per impostare le dimensioni corrette
    ...
    initChart() {
        ...
        chartContainer.style.height = '100%'; // Altezza iniziale, può essere modificata
    ...
    updatePlot() {
        ...
        try {
            ...
            let containerHeight = chartContainer.offsetHeight;
    
            if (containerWidth === 0 || containerHeight === 0) {
                this.log('Chart container has no dimensions. Retrying in 100ms.', 'warn');
                setTimeout(() => this.updatePlot(), 100);
                return;
            }
            ...
            // Forza un reset completo del grafico
            this.chart.clear();
            ...
            // Calcola le dimensioni corrette mantenendo l'aspetto quadrato delle celle
            const cellAspectRatio = this.metadata.nr_xdata / this.metadata.nr_ydata;
            let width, height;
    
            if (containerWidth / containerHeight > cellAspectRatio) {
    ...
    createChartOption(currentData, terrainData, metadata, variableIndex, zLevel, followTerrain, colormap, windData, windOptions) {
        ...
        // Calcola la dimensione del lato del quadrato come percentuale
        const sideLength = '80%'; // Usa l'80% della dimensione più piccola del contenitore
        ...
        return {
            ...
            grid: {
                ...
                width: sideLength,
                height: sideLength,
                aspect: 1, // Forza un aspect ratio di 1
                containLabel: true
            },
            xAxis: {
                type: 'category',

...
function getColormap(name) {
    const colormaps = {
        viridis: ['#0081a7','#00afb9','#fdfcdc','#fed9b7','#f07167'],
        plasma: ['#264653','#2a9d8f','#e9c46a','#f4a261','#e76f51'],
        inferno: ['#335c67','#fff3b0','#e09f3e','#9e2a2b','#540b0e'],
        magma: [ '#001427','#708d81','#f4d58d','#bf0603','#8d0801'],

...
function handleResize() {
    ...
    if (app.chart && width > 0 && height > 0) {
        app.chart.resize({width: width, height: height});
    }
}
...
const app = {
    ...
    initChart() {
        ...
        chartContainer.style.height = '100px'; // Puoi modificare questo valore secondo le tue esigenze
